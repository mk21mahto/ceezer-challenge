...
const ProductCard = ({ data }) => {
    const { image, id, name, supplier_name: supplierName, country, description, offered_volume_in_tons: volume, price_per_ton: price, earliest_delivery: deliveryDate } = data;
    const { cartItem, setCartItem } = useAppContext();
    const [purchaseVolume, setPurchaseVolume] = useState(getQuantityByName(name));

    function getQuantityByName(itemName) {
    ...
    return (
        <div className='border border-solid rounded-lg w-[300px] h-[300px]'>
